...
public class ToggleTextCaseActivity extends BaseActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_toggle_text_case);

        setTitle("Toggle Text Case");
        ...
        btnRandomNumberGeneratorSubmit.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (CommonFunctions.isEmptyEditText(et)) {
                    ...
                    CommonFunctions.resultSharingDialog(ToggleTextCaseActivity.this, text);
                }
