...
public class UnitLengthActivity extends AppCompatActivity {
    ...
    private double evaluate(int item1, int item2, double value) {
        ...
        if (item1 == item2)
            ...
            switch (item1){
                ...
                case 0:
                    temp = ca.MeterToNano(value);
                    break;

                case 1:
                    temp = ca.MeterToMilli(value);
                    break;

                case 2:
                    temp = ca.MeterToCenti(value);
                    break;

                case 4:
                    temp = ca.MeterToKilo(value);
                    break;

                case 5:
                    temp = ca.MeterToInch(value);
                    break;
